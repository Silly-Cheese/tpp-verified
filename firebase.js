...
export const firebaseConfig = {
  apiKey: "AIzaSyBuSff9JvSmY0N-FgHYIK12hO6ulWjvrnI",
  authDomain: "verify-tpp.firebaseapp.com",
  projectId: "verify-tpp",
  storageBucket: "verify-tpp.firebasestorage.app",
  messagingSenderId: "1090804856735",
  appId: "1:1090804856735:web:70cb9fdb6f8ba03e08efaa"
};
...
export function generateDocumentId() {
  ...
  return `TPP-VOL-${yyyy}${mm}${dd}-${random}`;
}
...
export async function initializeSystem() {
  ...
  if (!systemSnap.exists()) {
    await setDoc(systemRef, {
      name: "The Prayer Project Verification Portal",
...
export async function isAuthorizedAdmin(email) {
  ...
  const adminSnap = await getDoc(doc(db, COLLECTIONS.admins, normalized));
